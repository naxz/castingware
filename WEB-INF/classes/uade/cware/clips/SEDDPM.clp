(deftemplate Diagnostico
	...
	(multislot causas
		...
		(allowed-strings 	
			...
			"Las características ingresadas son cercanas a un defecto B-111, sin embargo el tamaño de cada cavidad difiere de lo definido, debiendo ser 'Pequeño (menor a 4mm)' o 'Mediano (4mm a 7mm)'"
			
			"Las características ingresadas son cercanas a un defecto B-111, sin embargo la forma cada cavidad difiere de lo definido, debiendo ser 'Redondeada' para llegar a este defecto."
			
			"Las características ingresadas son cercanas a un defecto B-111, sin embargo la distribución de las cavidades difiere de lo definido, debiendo ser 'Azarosa' para llegar a este defecto."
			
			"Las características ingresadas son cercanas a un defecto B-111, sin embargo la cantidad de las cavidades difiere de lo definido, debiendo ser 'Muchísimas (más de 10)' para llegar a este defecto."
		)
	)
)
...
(defrule R-B-111-1
	...
	(test (or (eq ?tamaño "Grande (mayor a 7mm y menor a 15mm)") (eq ?tamaño "Muy grande (mayor a 15mm)")))
	=>
	(assert
		(Diagnostico
			(subfamilia "No definida")
			(causas
				"Las características ingresadas son cercanas a un defecto B-111, sin embargo el tamaño de cada cavidad difiere de lo definido, debiendo ser 'Pequeño (menor a 4mm)' o 'Mediano (4mm a 7mm)'"
			)
		)
...
(defrule R-B-111-2
	...
	(test (or (eq ?tamaño "Pequeño (menor a 4mm)") (eq ?tamaño "Mediano (4mm a 7mm)")))
	(test (or (eq ?forma "Irregular redonda") (eq ?forma "Esférica")))
	=>
	(assert
		(Diagnostico
			(subfamilia "No definida")
...
(defrule R-B-111-3
	...
	(test (or (eq ?tamaño "Pequeño (menor a 4mm)") (eq ?tamaño "Mediano (4mm a 7mm)")))
	(test (or (eq ?distribucion "Alineadas rectas") (eq ?distribucion "Alineadas circulares")))		
	=>
	(assert
		(Diagnostico
			(subfamilia "No definida")
...
(defrule R-B-111-4
	...
	(test (or (eq ?tamaño "Pequeño (menor a 4mm)") (eq ?tamaño "Mediano (4mm a 7mm)")))
	(test (or (eq ?cantidad "Pocas (entre 2 y 5)") (eq ?cantidad "Muchas (entre 6 y 10)")))
	=>
	(assert
		(Diagnostico
			(subfamilia "No definida")
